...
namespace FTPServer
{
    public class ClientConnection : IDisposable
    {
        ...
        public void HandleClient(object obj)
        {
            ...
            try
            {
                while ((line = _controlReader.ReadLine()) != null)
                {
                    ...
                    var arguments = command.Length > 1 ? line.Substring(command[0].Length + 1) : string.Empty;
        ...
        private string EPort(string hostPort)
        {
            ...
            var rawSplit = hostPort.Split(new char[] { delimiter }, StringSplitOptions.RemoveEmptyEntries);
        ...
        private string ListOperation(NetworkStream dataStream, string pathname)
        {
            ...
            foreach (string dir in directories)
            {
                ...
                var line = string.Format("drwxr-xr-x    2 2003     2003     {0,8} {1} {2}", "4096", date, d.Name);
            ...
            foreach (string file in files)
            {
                ...
                var line = string.Format("-rw-r--r--    2 2003     2003     {0,8} {1} {2}", f.Length, date, f.Name);
                dataWriter.WriteLine(line);
                dataWriter.Flush();
            }
            var logEntry = new LogEntry
